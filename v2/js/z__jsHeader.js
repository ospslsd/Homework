...
Line 132:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 142:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 152:6 Transforming let to the configured target environment ("es5") is not supported yet
Line 153:6 Transforming let to the configured target environment ("es5") is not supported yet
Line 172:6 Transforming let to the configured target environment ("es5") is not supported yet
Line 213:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 257:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 269:4 Transforming const to the configured target environment ("es5") is not supported yet
