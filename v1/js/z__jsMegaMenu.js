...
Line 58:6 Transforming let to the configured target environment ("es5") is not supported yet
Line 133:4 Transforming let to the configured target environment ("es5") is not supported yet
